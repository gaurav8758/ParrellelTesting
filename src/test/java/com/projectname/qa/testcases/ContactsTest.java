...
public class ContactsTest extends TestBase {
	...
	@Test(priority = 1,enabled = true, groups="FREECRM")
	...
	@Test(priority = 2,enabled = true, groups="TestFun")
	...
	@Test(priority = 2,dataProvider="getCRMTestData", enabled=true, groups="FREECRM")
